...
<!--</div>-->
      ...
      <div class="col-md-6 ">
        ...
        <form action="../../phpfiles/newsletter" method="post" class="collapse" id="newsletter">
          <div class="form-group">
              <label for="#news_name">Name </label>
              <input type="text" class="form-control" id="news_name" placeholder="Enter your name" name='name' required>
          </div>
          <div class="form-group">
              <label for="#news_email">E-mail </label>
              <input type="email" class="form-control" id="news_email" placeholder="Enter your email" name='email' required>
          </div>
          <button type="submit" class="btn btn-success" >Send</button>
        </form>
